...
public class _113M_MaximumSumCircularSubarray {

    public static void main(String[] args) {
        int[] nums;

        nums = new int[]{1,-2,3,-2};
        System.out.println("maxSubarraySumCircular for nums = "+ Arrays.toString(nums) +" equals "+maxSubarraySumCircular(nums));
        // 3
        System.out.println();
