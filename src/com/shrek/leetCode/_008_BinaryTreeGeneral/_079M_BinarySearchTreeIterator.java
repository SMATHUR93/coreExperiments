...
public class _079M_BinarySearchTreeIterator {

    public static void main(String[] args) {

        Integer[] arr1 = new Integer[]{7, 3, 15, null, null, 9, 20};
        TreeNode root = makeTree(arr1);
        
        BSTIterator new_iterator = new BSTIterator(root);
